...
const mockRequest = { url: 'http://localhost:3000/api/health/live', method: 'GET' } as unknown as Request;

describe('liveness API', () => {
  it('returns 200 with status ok', async () => {
    const response = await GET(mockRequest) as unknown as MockResponse;
